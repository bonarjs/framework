    ...
    <Card>
      <TabContext value={value}>
        <TabList onChange={handleChange} aria-label='card navigation example' >
          <Tab value='1' label='Empreender' className='text-xs px-3'/>
          <Tab value='2' label='Escalar' className='text-xs px-3' />
          <Tab value='3' label='Causar impacto' className='text-xs px-3' />
        </TabList>
        <CardContent>
          <TabPanel value='1' sx={{ p: 0 }}>
            <Typography variant='h6' sx={{ marginBottom: 2 }} className='text-base'>
              Programa de Aceleração Artística
            </Typography>
